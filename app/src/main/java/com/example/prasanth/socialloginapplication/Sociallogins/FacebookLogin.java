...
import com.example.prasanth.socialloginapplication.FbPageNavigateInterface;
...
/**
 * Created by Prasanth on 10/17/2017.
 */
...
public class FacebookLogin {
    ...
    private FbPageNavigateInterface fbPageNavigateInterface;
                        ...
                        try {
                            ...
                            if (jsonObjectResponse != null) {
                                try {
                                    ...
                                    responseUserData.putString("fbUserId", loginResult.getAccessToken().getUserId());
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                            }
                            /*using interface to call intent*/
                            fbPageNavigateInterface.navigateToFbProfilePage(responseUserData);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
